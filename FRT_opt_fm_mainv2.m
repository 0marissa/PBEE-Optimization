...
control.impeding_factors   = false; 
...
analysis_run_number = "98";
analysis_hazardLevel =  "475";
analysis_impeding_factors = "0";
analysis_nsim = "1000"

analysis_recovery_model = "ATC138_surr";
...
%out = fn_optimize_debug(control, problem, params);
