function [ damage ] = fn_restructure_repair_schedule( damage, system_schedule, ...
    repair_complete_day_per_system, systems, global_fail, replacement_time,  tmp_repair_complete_day)
...
for tu = 1:num_units
    ...
    damage.tenant_units{tu}.recovery.repair_start_day(global_fail,:) = 0;
    damage.tenant_units{tu}.recovery.repair_complete_day(global_fail,:) = replacement_time;
