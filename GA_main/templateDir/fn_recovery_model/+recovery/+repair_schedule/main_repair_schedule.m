function [damage, worker_data, building_repair_schedule ] = main_repair_schedule(...
    damage, building_model, damage_consequences, simulated_red_tags, repair_time_options, ...
...
[ damage ] = fn_restructure_repair_schedule( damage, system_schedule, repair_complete_day_per_system, systems, ...
    damage_consequences.global_fail, building_model.replacement_time_days, tmp_repair_complete_day);
